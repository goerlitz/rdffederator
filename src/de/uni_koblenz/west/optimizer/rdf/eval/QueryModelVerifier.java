...
/**
 * Used for verifying the results of the query optimization.
 * 
 * @author Olaf Goerlitz
 */
public interface QueryModelVerifier<P, F> {
	
	public QueryModelEvaluator<BGPOperator<P, F>, ? extends Number> getEvaluator();
